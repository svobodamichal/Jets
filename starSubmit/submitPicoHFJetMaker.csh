...
starver pro
#starver SL19c #REMEMBER TO CHANGE BACK TO PRO ONCE NOT NEEDED!!
...
# -- set root macro
set rootMacro=runPicoHFJetMaker.C

# -- set filename for bad run list
#set badRunListFileName="BadRunList_MB.list"
set badRunListFileName="BadRunList_14.list"
#orig. picoList_bad_MB.list, Vanek

# -- set filename for hot tower list
#set hotTowerListFileName="HotTowerList_14.list"
...
# -- set STAR software version
set starVersion=pro
#set starVersion=SL19c #REMEMBER TO CHANGE BACK TO PRO ONCE SOLVED
...
set productionbasePath=/star/data41/reco/AuAu_200_production_low_2014/ReversedFullField/P18ih/2014/

# -- submission xml file 
set xmlFile=submitPicoHFJetMaker.xml
...
set folders="StRoot starSubmit fastjet fastjet1"
...
#echo -n "Checking hot tower list  ...         "
#if  ( -e ${baseFolder}/${hotTowerListFileName} ) then
#    cp  ${baseFolder}/${hotTowerListFileName} HotTowerList_14.list
#else if ( -e ${baseFolder}/picoLists/${hotTowerListFileName} ) then
#    cp  ${baseFolder}/picoLists/${hotTowerListFileName} HotTowerList_14.list
#else
#    echo "${hotTowerListFileName} does not exist in ${baseFolder} nor ${baseFolder}/picoLists"
#    exit
#endif
#echo "ok"
...
echo '<\!ENTITY badrunlist "'${badRunListFileName}'">'  		       >> $hackTemplate
#echo '<\!ENTITY hottowerlist "'${hotTowerListFileName}'">'  		       >> $hackTemplate
