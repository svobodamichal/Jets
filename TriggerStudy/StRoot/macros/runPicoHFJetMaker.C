...
using namespace std;
//using namespace contrib; do I need this?
...
//			const Char_t *badRunListFileName="BadRunList_14.list", const Char_t *hotTowerListFileName="HotTowerList_14.list", const Char_t *treeName = "picoDst") {
 ...
 picoCuts->addTriggerId(450025);    // vpdmb-5-p-nobsmd*/
    ...
    //2014 BHT1*VPD30 triggers
    picoCuts->addTriggerId(450201);    // BHT1*VPD30
    picoCuts->addTriggerId(450211);    // BHT1*VPD30
...
//vector<float> EmbPt;  EmbPt.push_back(5.0); EmbPt.push_back(20.0);
  ...
  stPicoHFJetMaker->setTriggerThreshold(0.0); //~4.2 is the HT2 threshold
