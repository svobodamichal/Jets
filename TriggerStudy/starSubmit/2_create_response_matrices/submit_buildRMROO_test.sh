...
CENTSUFF="central"
PTLEADCUTS="5 7" # "5 6 7 9" pythia prior not defined for pTlead = 9
...
export PRIOR_START=9 #starting prior #prior number 2 (pythia) not defined for pTlead = 9
export PRIOR_STOP=18 #last prior
export PRIOR_SKIP1=99 #skip this prior
export PRIOR_SKIP2=99 #skip this prior
export PRIOR_SKIP3=99 #skip this prior
