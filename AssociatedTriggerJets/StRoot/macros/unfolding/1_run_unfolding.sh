...
#export PRIOR_MIN=2 #start with this prior function #2 default, 4 for pTlead 9
#export PRIOR_MAX=15 #finish with this prior function
#export PRIOR_SKIP1=4 #skip this prior function
#export PRIOR_SKIP2=3
#export PRIOR_SKIP3=6

#TEST WITH NEW PRIORS
export PRIOR_MIN=2 #start with this prior function #2 default, 4 for pTlead 9
export PRIOR_MAX=15 #finish with this prior function #18 max 
export PRIOR_SKIP1=3 #skip this prior function
export PRIOR_SKIP2=71
export PRIOR_SKIP3=71
...
export RMATRIX_PATH="$WRKDIR/responseM_${TRG}/$SUFFIX/rmatrix${TSUFF}/ROOformat"
...
for BININGCH in 7 # - equidistant binning #-test binning #5 #-full jets  #6 #0 1 4 #1 2 3 4 #choice of bining arrays 0: nu=nm, 1: nu<nm, 2: nu<nm
do
export BININGCH 
...
#	if [ $SECONDUNFOLD -eq 0 ]; then
		...
		OUT_DIR="$ANALYSISDIR/Unfolded_${TRG}${EFFSUF}/unfolding/${UTYPE}/${SUFFIX}"
#	else
