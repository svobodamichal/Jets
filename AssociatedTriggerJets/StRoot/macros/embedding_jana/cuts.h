...
static const Double_t    RatioHit       = 0.52;   // TPC hits fitted/possible hits, was by mistake Int_t!
static const Int_t    TpcCut         = 12;   //15, TPC hits fitted
static const Int_t    TpcMcCut       = 12;   // TPC hits fitted, Jana: was 10 ???
...
static const Int_t refMultCutMax[3]={43,2000, 2000};//multiplicity cut for peripheral/central collisions //Was by mistake 31, should be 43
